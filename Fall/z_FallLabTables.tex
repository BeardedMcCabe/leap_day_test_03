...
\include{ErrorAnalysis} % ErrorAnalysis
\include{GraphicalRepresentation} % GraphicalRepresentation
\include{VernierCalipers} % VernierCalipers
\include{DataAcquisition} % DataAcquisition
